// Netlify Function — elimina un chunk Knowledge Base da Firestore
...
export default async (req) => {
  ...
  try {
    ...
    await firestore.collection('knowledgeChunks').doc(id).delete()
...
export const config = { path: '/api/kb-delete' }
